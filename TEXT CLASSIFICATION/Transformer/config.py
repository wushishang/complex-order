...
#     TaskType, Constants, ModelType, InputType, GinModelType, LossType, SetFunction, InputEmbedType, RegRepresentation, \
#     GinPositionalEncodingType
#
# RESULT_DIR = "../results/"
# MODEL_DIR = "../models/"
...
#         """
#         data_params = [self.input_type.name, self.data_cfg.experiment_data.name, self.cv_fold, self.train_all]
#
...
#                             self.data_cfg.n_splits, self.data_cfg.scale_target, self.data_cfg.l_type.name, sps_str, perm_type_str]
...
#                 warn_msg += "!" * 30
#                 warn(warn_msg)
#         train_params = (["TRA"] if not self.testing else ["TES"]) + train_params
#
